...
void processMenuEvents(int option) {
    ...
    case rv: a *= -1; break;
    case clkws: a = -1; break;
    case aclkws: a = 1; break;
    case stop: a = 0; break;
    case pls1: a += 1; break;
    case mns1: a -= 1; break;
...
void createGLUTMenus() {
    ...
    int menu, submenu, submenu1, submenu2;
    ...
    glutAddMenuEntry("Reverse", rv);
    glutAddMenuEntry("Clockwise", clkws);
    glutAddMenuEntry("Anti-Clockwise", aclkws);

    submenu2 = glutCreateMenu(processMenuEvents);
    glutAddMenuEntry("Stop", stop);
    glutAddMenuEntry("Plus 1", pls1);
    glutAddMenuEntry("Minus 1", mns1);
    glutAddMenuEntry("Times by 2", tms2);
    glutAddMenuEntry("Divid by 2", div2);
